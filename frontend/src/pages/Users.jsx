...
function Users() {
  ...
  // Apple-style color palette for roles
  const getRoleStyle = (role) => {
    switch (role?.toLowerCase()) {
      case "admin":
        return { bg: "rgba(0, 122, 255, 0.12)", color: "#007aff" }; // SF Blue
      case "doctor":
        return { bg: "rgba(40, 200, 64, 0.12)", color: "#28c840" }; // SF Green
      case "receptionist":
        return { bg: "rgba(255, 159, 10, 0.12)", color: "#ff9f0a" }; // SF Orange
      default:
        return { bg: "rgba(142, 142, 147, 0.12)", color: "#8e8e93" }; // SF Gray
    }
  };
  ...
  if (loading) return <div style={{ padding: "40px", color: "#424245", fontSize: "13px" }}>Loading system users...</div>;
